...
class ProfileGenerator(private val dao: VirtualProfileDao? = null) {
    ...
    private fun generatePhoneNumber(countryIso: String): String {
        return when (countryIso) {
            "us" -> "+1${"%03d".format(random.nextInt(200, 999))}${"%03d".format(random.nextInt(100, 999))}${"%04d".format(random.nextInt(1000, 9999))}"
            "gb" -> "+44${"%04d".format(random.nextInt(7000, 7999))}${"%06d".format(random.nextInt(100000, 999999))}"
            "jp" -> "+81${"%02d".format(random.nextInt(70, 99))}${"%04d".format(random.nextInt(1000, 9999))}${"%04d".format(random.nextInt(1000, 9999))}"
            "cn" -> "+86${"%03d".format(random.nextInt(130, 199))}${"%04d".format(random.nextInt(1000, 9999))}${"%04d".format(random.nextInt(1000, 9999))}"
            "in" -> "+91${"%05d".format(random.nextInt(70000, 99999))}${"%05d".format(random.nextInt(10000, 99999))}"
            else -> "+1${"%03d".format(random.nextInt(200, 999))}${"%03d".format(random.nextInt(100, 999))}${"%04d".format(random.nextInt(1000, 9999))}"
        }
    }

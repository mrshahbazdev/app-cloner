...
abstract class CloneEngineApi {
  ...
  @async
  CloneInfo createClone(String packageName, int userId, String? profilePreset);
  ...
  @async
  DeviceProfile? getCloneProfile(String cloneId);

  /// Update virtual profile for a clone.
  @async
  bool updateProfile(String cloneId, DeviceProfile profile);

  /// Reset virtual profile to new random values.
  @async
  DeviceProfile resetCloneProfile(String cloneId);

  /// Get storage info for a clone.
  @async
  StorageInfo getCloneStorageInfo(String cloneId);
  ...
  CompatReport checkCompatibility();

  /// Get battery optimization info.
  BatteryInfo getBatteryOptimizationInfo();
